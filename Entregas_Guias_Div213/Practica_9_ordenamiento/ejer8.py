...
def listar_mexicanos_por_orden()->list:
...
def listar_usuarios_jovenes_ordenados()->list:
    usuarios = nombres
...
def mexicanos_y_brasileros_ordenados_por_nombres_y_mayores_a_8000_en_cod_postal()->list:
    usuarios = nombres
